...
static const GEnumValue _wnck_pager_layout_policy_values[] = {
  { WNCK_PAGER_LAYOUT_POLICY_AUTOMATIC, "WNCK_PAGER_LAYOUT_POLICY_AUTOMATIC", "automatic" },
  { WNCK_PAGER_LAYOUT_POLICY_WIDTH_FOR_HEIGHT, "WNCK_PAGER_LAYOUT_POLICY_WIDTH_FOR_HEIGHT", "width-for-height" },
  { WNCK_PAGER_LAYOUT_POLICY_HEIGHT_FOR_WIDTH, "WNCK_PAGER_LAYOUT_POLICY_HEIGHT_FOR_WIDTH", "height-for-width" },
  { 0, NULL, NULL }
};

GType
wnck_pager_layout_policy_get_type (void)
{
  static GType type = 0;

  if (!type)
    type = g_enum_register_static ("WnckPagerLayoutPolicy", _wnck_pager_layout_policy_values);
